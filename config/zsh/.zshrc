...
__conda_setup="$('/home/satch/exit/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/satch/exit/etc/profile.d/conda.sh" ]; then
        . "/home/satch/exit/etc/profile.d/conda.sh"
    else
        export PATH="/home/satch/exit/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
