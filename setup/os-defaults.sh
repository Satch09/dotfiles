...
# Sane controllable key repeatition rate
defaults write NSGlobalDomain InitialKeyRepeat -int 27
...
# Save screenshots to Screenshots folder under Documents directory
